...
new_directory = './input_audio_dataset/wave/'
#Step 2 - convert WAVs to frequency domain with mean 0 and standard deviation of 1
convert_wav_files_to_nptensor(new_directory, block_size, max_seq_len, output_filename,useTimeDomain=True)
